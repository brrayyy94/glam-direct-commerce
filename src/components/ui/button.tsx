  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white hover:scale-105 shadow-card hover:shadow-hover transition-bounce font-semibold",
        whatsapp: "bg-green-500 text-white hover:bg-green-600 shadow-soft hover:shadow-hover",
        coral: "bg-coral text-white hover:bg-coral/90 shadow-soft hover:shadow-hover",
        nude: "bg-nude text-foreground hover:bg-nude/80 shadow-soft",
      },
      size: {
